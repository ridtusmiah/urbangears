											...
											<li>
												<div class="timeline-panel">
													<div class="media mr-2">
														<img alt="image" width="50" src="{{asset('admin/public/images/avatar/1.jpg')}}">
													</div>
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
									<div class="header-info">
										<span class="text-black">Hello,<strong>{{ request()->session()->get('username') }}</strong></span>
										<p class="fs-12 mb-0">{{ request()->session()->get('userrole') }}</p>
									</div>
                                    <img src="{{asset('admin/public/images/profile/17.jpg')}}" width="20" alt=""/>
                                </a>
                                <div class="dropdown-menu dropdown-menu-right">
