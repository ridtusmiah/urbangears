      ...
      <div class="row">
        <div class="col-xl-8 col-lg-6 col-md-7 col-sm-8">
          <div class="card-bx stacked">
            <img src="{{asset('admin/public/images/card/card.png')}}" alt="" class="mw-100">
            <div class="card-info text-white">
              ...
              <div class="d-flex align-items-center justify-content-between mb-sm-5 mb-3">
                <img src="{{asset('admin/public/images/dual-dot.png')}}" alt="" class="dot-img">
            ...
            <a href="cards-center-2.html"><i class="fa fa-caret-down" aria-hidden="true"></i></a>
          </div>
        </div>
              ...
              <div class="owl-carousel testimonial-one mb-5">
                <div class="item">
                  <div class="image-bx mb-3">
                    <img src="{{asset('admin/public/images/avatar/1.jpg')}}" alt="">
                    <i class="las la-check-circle"></i>
                  </div>
                  <h6 class="fs-16 mb-0"><a href="transactions-details.html" class="text-black">David</a></h6>
                  <span class="fs-12">@davidxc</span>
                </div>
                <div class="item">
                  <div class="image-bx mb-3">
                    <img src="{{asset('admin/public/images/avatar/2.jpg')}}" alt="">
                    <i class="las la-check-circle"></i>
                  </div>
                  <h6 class="fs-16 mb-0"><a href="transactions-details.html" class="text-black">Cindy</a></h6>
                  <span class="fs-12">@cindyss</span>
                </div>
                <div class="item">
                  <div class="image-bx mb-3">
                    <img src="{{asset('admin/public/images/avatar/3.jpg')}}" alt="">
                    <i class="las la-check-circle"></i>
                  </div>
                  <h6 class="fs-16 mb-0"><a href="transactions-details.html" class="text-black">Samuel</a></h6>
                  <span class="fs-12">@sam224</span>
                </div>
                <div class="item">
                  <div class="image-bx mb-3">
                    <img src="{{asset('admin/public/images/avatar/4.jpg')}}" alt="">
                    <i class="las la-check-circle"></i>
                  </div>
                  <h6 class="fs-16 mb-0"><a href="transactions-details.html" class="text-black">Olivia</a></h6>
                  <span class="fs-12">@oliv62</span>
                </div>
                <div class="item">
                  <div class="image-bx mb-3">
                    <img src="{{asset('admin/public/images/avatar/5.jpg')}}" alt="">
                    <i class="las la-check-circle"></i>
                  </div>
                  <h6 class="fs-16 mb-0"><a href="transactions-details.html" class="text-black">Martha</a></h6>
                  ...
                  <table class="table table-responsive-md card-table previous-transactions">
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <h6 class="fs-16 font-w600 mb-0"><a href="transactions-details.html" class="text-black">XYZ Store ID</a></h6>
                      ...
                      <tr>
                        ...
                        <td>
                          <h6 class="fs-16 font-w600 mb-0"><a href="transactions-details.html" class="text-black">Chef Renata</a></h6>
                      ...
                      <tr>
                        ...
                        <td>
                          <h6 class="fs-16 font-w600 mb-0"><a href="transactions-details.html" class="text-black">Cindy Alexandro</a></h6>
                          <span class="fs-14">Transfer</span>
                        </td>
                        <td>
                          <h6 class="fs-16 text-black font-w400 mb-0">June 5, 2020</h6>
                      ...
                      <tr>
                        ...
                        <td>
                          <h6 class="fs-16 font-w600 mb-0"><a href="transactions-details.html" class="text-black">Hawkins Jr.</a></h6>
                          <span class="fs-14">Transfer</span>
                        </td>
                        <td>
                          <h6 class="fs-16 text-black font-w400 mb-0">June 4, 2020</h6>
